...
export class InpatientAdjudicationInformation {
    ...
    public pps_operating_outlier_amount: number = 0;
    public lifetime_psychiatric_days_count: number | null = null;
    public claim_DGR_amount: number = 0;
    public claim_disproportionate_share_amount: number = 0;
    public claim_msp_pass_thru_amt: number = 0;
    public claim_pps_capital_amount: number = 0;
    public pps_capital_fsp_drg_amt: number = 0;
    public pps_capital_hsp_drg_amt: number = 0;
    public pps_capital_dsh_drg_amt: number = 0;
    public old_capital_amount: number = 0;
    public pps_capital_ime_amount: number = 0;
    public pps_oper_hsp_spec_drg_amt: number = 0;
    public cost_report_day_count: number | null = null;
    public pps_oper_fsp_spec_drg_amt: number = 0;
    public claim_pps_outlier_amount: number = 0;
    public claim_indirect_teaching: string = '';
    public non_pay_prof_comp_amt: number = 0;
    ...
    public pps_capital_exception_amt: number = 0;
